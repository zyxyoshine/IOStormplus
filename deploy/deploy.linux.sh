...
cd /home && wget https://github.com/zyxyoshine/IOStormplus/archive/dev.zip
cd /home && unzip dev.zip
cd /home/IOStormplus-dev/src/agent/linuxagent && make
mkdir /home/fiojob
cp -pf /home/IOStormplus-dev/src/agent/linuxagent/agent /home/fiojob/
